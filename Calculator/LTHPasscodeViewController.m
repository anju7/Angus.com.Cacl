...
- (void)prepareNavigationControllerWithEnablingPasscodeController:(UIViewController *)viewController {
...
- (void)showForEnablingPasscodeInViewController:(UIViewController *)viewController {
	...
	[self prepareNavigationControllerWithEnablingPasscodeController: viewController];
